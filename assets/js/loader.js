...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Ajout de quelques etudiants", "Création des options", "Construction des classes", "On rajoute peu de magie", "On rajoute Une pointe d'humour ", "On rajoute Un peu de serieux ", "Création des clubs", "Organisation de soirées", "On nourrit les unicorns.. ", "Rajout du BDE", "Création des formations en alternance", "Géneration du contenue de la page"]);
